  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await fetch(
        "https://apiroutetapxtream.invtechnologies.in/create_payment_service",
        {
          method: "POST",
          headers: {
      ...
      setErrorMsg("Failed to generate payment link. Contact admin.");
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        {cardData.cardType === "Basic NFC Card" && (
          <>
              ...
              >
                ...
                >
                  <Box>
                    ...
                    >
                      <CallIcon fontSize="small" /> {cardData.mobileNumber}{" "}
                    </Typography>
                    <Typography
                      sx={{
                        display: "flex",
                    ...
                    >
                      <MailIcon fontSize="small" /> {cardData.email}{" "}
                    </Typography>
                  </Box>
                  <Box
                    component="img"
                ...
                >
                  <Box>
                    <Typography sx={{ fontSize: "14px", fontWeight: "bold" }}>
                      {cardData.firstName} {cardData.middleName}{" "}
                      {cardData.lastName}
                    </Typography>
                    {!cardData.designation || cardData.designation === "" ? (
                      <Box p={1} />
                    ) : (
            ...
            <Typography
              sx={{ color: "blue", fontWeight: 600, fontSize: "1.2rem" }}
            >
              ₹299.00{" "}
              <del style={{ color: "red", fontWeight: "lighter" }}>₹799.00</del>
            </Typography>
          </>
        )}
        ...
        {cardData.cardType === "Premium NFC Card" && (
          <>
            ...
            >
              ₹599.00{" "}
              <del style={{ color: "red", fontWeight: "lighter" }}>₹999.00</del>
            </Typography>
          </>
        )}
        ...
        {errorMsg && (
          <Typography sx={{ color: "red", fontWeight: 600 }}>{errorMsg}</Typography>
        )}
        <Box
          sx={{
            display: "flex",
